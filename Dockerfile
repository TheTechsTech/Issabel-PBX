...
RUN chmod 6711 /usr/bin/procmail \
    ...
    && systemctl.original enable denyhosts.service fail2ban.service mariadb.service asterisk.service httpd.service issabeldialer.service fop2.service hylafax.service wakeup_survey crond.service postfix.service saslauthd.service cyrus-imapd.service sshd-keygen.service sshd.service webmin.service \
